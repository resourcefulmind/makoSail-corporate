  ...
  return (
    <div className='makosail__header section__padding' id='home'>
      <div className="makosail__header-content">
        <h1 className="gradient__text">A Race To Innovate, a World of Rewarding Experiences. <br /> Health & Fitness, Construction, Renewable Energy and a Cutting Edge Technology Hub.</h1>
        ...
        <div className="makosail__header-content__people">
          ...
          <p>1800 sign-ups for our services globally from households, businesses and organizations.</p>
        </div>

        <div className="makosail__header-image">
          <img src={images.fourthheader} alt="makosail header" />
        </div>
      </div>
